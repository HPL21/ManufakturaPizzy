            ...
            <div class="max-w-7xl mx-auto p-6 lg:p-8">
                ...
                <div class="mt-16">
                    <div class="flex justify-center">
                        <a href="{{ route('restaurant') }}" class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded-full">
                            Restauracja
                        </a>
                    </div>
                    <div class="flex justify-center">
                        <a href="{{ route('home') }}" class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded-full">
